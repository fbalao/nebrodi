...
lapply(known_mother, write, "nebrodi_KnownMatSibs.txt", append=TRUE, ncolumns=1000, sep="\t")
...
write.table(markers,file="nebrodi_markers.txt", sep="\t", col.names = F, row.names = F, quote = F)
