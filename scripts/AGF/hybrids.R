...
##### 8/5/2021 Export data adults NB and alba & cephalonica for structure
#### 95 loci in mothers?
library(radiator)
poolabies_adults<-repool(abies_genindc_sub, padresDB_sub)

genomic_converter(
  poolabies_adults,
  output = "structure",
  filename = "nebrodialbacephalonica98loc.str",
  parallel.core = parallel::detectCores() - 1,
  verbose = TRUE)

genind2structure(poolabies_adults, file="nebrodialbacephalonica98loc.str")
